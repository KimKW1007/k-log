      ...
      {isRemoveTurnBanner || <BannerInnerBox ref={innerBoxRef}>
        <BannerSlideBox>
          {bannerList.map((ele,idx) => (
            <BannerItem key={'salt' + idx} currentRotate={currentRotate} boxWidth={innerBoxWidth} itemLength={itemLength} boxHeight={innerBoxHeight} delay={idx} resetRotate={resetRotate}></BannerItem>
          ))}
        </BannerSlideBox>
      </BannerInnerBox>}
    </BannerWrap>
